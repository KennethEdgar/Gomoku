...
int assign_score(int a , int b){
   ...
   //////== EN 
    ...
    currscore = currscore + (usfives * 150);
            ...
            for(int j = 0; j < 15; j++){
                ...
                if(tempmark[i][j] == 1){
                  ...
                  //  newestmark.push(node(i,j));
                    int theminimax = minimax(depth - 1,alpha,beta,false);
        ...
        for(int i = 0; i < 15; i++){
            for(int j = 0; j < 15 ;j++){
                ...
                if(tempmark[i][j] == 1){
                    ...
                    int theminimax = minimax(depth-1,alpha,beta,true);
...
void write_valid_spot(std::ofstream& fout) {
    ...
    minimax(4,INT_MIN, INT_MAX , true);
